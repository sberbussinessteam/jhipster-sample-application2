...
@RestController
@RequestMapping("/api/jhipster-sample-application-2-kafka")
public class JhipsterSampleApplication2KafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterSampleApplication2KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSampleApplication2KafkaResource(KafkaProperties kafkaProperties) {
