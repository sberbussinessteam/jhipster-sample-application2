...
export const CountryDeleteDialog = (props: ICountryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication2App.country.delete.question">
        <Translate contentKey="jhipsterSampleApplication2App.country.delete.question" interpolate={{ id: countryEntity.id }}>
