...
export const TaskDeleteDialog = (props: ITaskDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication2App.task.delete.question">
        <Translate contentKey="jhipsterSampleApplication2App.task.delete.question" interpolate={{ id: taskEntity.id }}>
