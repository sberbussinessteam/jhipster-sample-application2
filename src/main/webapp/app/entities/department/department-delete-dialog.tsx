...
export const DepartmentDeleteDialog = (props: IDepartmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication2App.department.delete.question">
        <Translate contentKey="jhipsterSampleApplication2App.department.delete.question" interpolate={{ id: departmentEntity.id }}>
