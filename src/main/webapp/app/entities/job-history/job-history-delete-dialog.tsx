...
export const JobHistoryDeleteDialog = (props: IJobHistoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication2App.jobHistory.delete.question">
        <Translate contentKey="jhipsterSampleApplication2App.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
