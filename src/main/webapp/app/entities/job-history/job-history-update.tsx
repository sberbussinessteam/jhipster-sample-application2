  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication2App.jobHistory.home.createOrEditLabel">
            <Translate contentKey="jhipsterSampleApplication2App.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="FRENCH">{translate('jhipsterSampleApplication2App.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('jhipsterSampleApplication2App.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('jhipsterSampleApplication2App.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label for="job-history-job">
                  <Translate contentKey="jhipsterSampleApplication2App.jobHistory.job">Job</Translate>
                </Label>
