...
export const EmployeeDeleteDialog = (props: IEmployeeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication2App.employee.delete.question">
        <Translate contentKey="jhipsterSampleApplication2App.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
