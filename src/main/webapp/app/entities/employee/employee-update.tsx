  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplication2App.employee.home.createOrEditLabel">
            <Translate contentKey="jhipsterSampleApplication2App.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : employeeEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <UncontrolledTooltip target="firstNameLabel">
                  <Translate contentKey="jhipsterSampleApplication2App.employee.help.firstName" />
                </UncontrolledTooltip>
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="emailLabel" for="employee-email">
                  <Translate contentKey="jhipsterSampleApplication2App.employee.email">Email</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="salaryLabel" for="employee-salary">
                  <Translate contentKey="jhipsterSampleApplication2App.employee.salary">Salary</Translate>
                </Label>
