...
export const RegionDeleteDialog = (props: IRegionDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication2App.region.delete.question">
        <Translate contentKey="jhipsterSampleApplication2App.region.delete.question" interpolate={{ id: regionEntity.id }}>
