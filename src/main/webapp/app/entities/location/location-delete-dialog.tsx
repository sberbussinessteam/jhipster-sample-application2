...
export const LocationDeleteDialog = (props: ILocationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication2App.location.delete.question">
        <Translate contentKey="jhipsterSampleApplication2App.location.delete.question" interpolate={{ id: locationEntity.id }}>
