...
export const JobDeleteDialog = (props: IJobDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplication2App.job.delete.question">
        <Translate contentKey="jhipsterSampleApplication2App.job.delete.question" interpolate={{ id: jobEntity.id }}>
